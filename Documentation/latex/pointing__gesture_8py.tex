...
\begin{DoxyCompactList}\small\item\em It simulate the pointing gesture command given by the user it generates pointing gestures given as an array int\mbox{[}\mbox{]} (ros message Int\+Array) at random times. \end{DoxyCompactList}\end{DoxyCompactItemize}
