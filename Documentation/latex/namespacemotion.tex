...
movement in the S\+L\+E\+EP state \index{motion@{motion}!reach\+\_\+goal@{reach\+\_\+goal}}
\index{reach\+\_\+goal@{reach\+\_\+goal}!motion@{motion}}
\subsubsection[{\texorpdfstring{reach\+\_\+goal()}{reach_goal()}}]{\setlength{\rightskip}{0pt plus 5cm}def motion.\+reach\+\_\+goal (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{namespacemotion_a58accc2356096af3ae30fe9442a1a482}{}\label{namespacemotion_a58accc2356096af3ae30fe9442a1a482}


function reach\+\_\+goal 

move to the goal position given by the user pointing gesture \index{motion@{motion}!update\+\_\+position@{update\+\_\+position}}
...
global variables \index{motion@{motion}!goal@{goal}}
\index{goal@{goal}!motion@{motion}}
