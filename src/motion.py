...
def move_normal():
	rospy.loginfo("NODE MOTION: Execute function to move in normal mode to a random position")
	# global map_2D
	## get random position
	...
	rospy.sleep(random_time*random.randint(5,25))
...
def main():
	...
	rospy.loginfo('NODE MOTION: publisher')
